...
var backendBase = {
  ...
  secrets: {
    session: process.env.SECRET || 'kol-secret'
  },
...
var development = {
  frontend: {
    ...
    assetsPublicPath: '/',
    proxyTable: {
      '/api': { target: 'http://backend:' + backendBase.port, changeOrigin: true },
      '/socket.io': { target: 'http://backend:' + backendBase.port, changeOrigin: true, ws: true }
    },
