  ...
  <div class="login-wrapper" v-show="!loggedIn">
    ...
    <el-form ref="form" :model="form" :rules="rules"
      ...
      <el-form-item prop="username">
        <el-input v-model="form.username" placeholder="Please input the username"></el-input>
      </el-form-item>
      <el-form-item prop="password">
        <el-input v-model="form.password" type="password" placeholder="Please input the password"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button class="login-button" :class="{error: loginError}" type="success"
          native-type="submit" :loading="loading">Log in</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
